"""
Modelo 3: Gradient Boosting — Customer Churn Prediction
Pipeline: StandardScaler → GradientBoostingClassifier + GridSearchCV
...
def train_gradient_boosting(df, test_size=0.2, random_state=42, cv_folds=5):
...
if __name__ == '__main__':
    ...
    model = train_gradient_boosting(df)
    joblib.dump(model, 'model_gradient_boosting.pkl')
    print("\nModelo guardado en: model_gradient_boosting.pkl")
